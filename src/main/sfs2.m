function [rParaOut,X,xtilde,fxtilde,x,fx]=sfs2(p,A,d,c,k,xRelaxedOpt,ixstar,diagInv,targetfbest ,IotherPara,IstopCondPara, iPara,rPara,textfileName,todebug)
% VS: 05/21/24
...
if k==1 || (p-k)==1
   [rParaOut,X,xtilde,fxtilde,x,fx]=sfs1(p,A,d,c,k,xRelaxedOpt,ixstar,diagInv,targetfbest ,IotherPara,IstopCondPara, iPara,rPara,textfileName,todebug);
   return;
end
