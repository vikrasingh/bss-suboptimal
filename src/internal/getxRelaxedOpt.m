function [bestAlgoFlag,lb,ub,solsOfQuadMin,cpuxRelaxedOpt,xRelaxedOpt,fxRelaxedOpt,A,b,c]=getxRelaxedOpt(pDim,yArray,xMatrix,trueb,iPara,rPara,QuadMinFunPara,IotherPara,version_flag,folderPath)
%==============================================================================================================================================
...
if ~isempty(fileid)
	...
	fprintf(fileid,'eig A(1:50)=\n');
        printArray(eigenvalues(1:50),'%1.4f',fileid);
    end
