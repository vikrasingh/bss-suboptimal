...
The following suboptimal algorithms have been implemented
...
5. Discrete First Order (DFO)
6. Adaptive Best Subset Selection (ABESS)
7. Mixed Integer Optimization (MIO)
