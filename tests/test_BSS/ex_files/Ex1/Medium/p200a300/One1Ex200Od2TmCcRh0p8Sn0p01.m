...
pDim_values=[200]      % values of pDim to run
nPts_values=[1000]      % nPts corresponding to each pDim
...
corrflag_option=[1  1]    % constant or exponential corr. for each pDim run
rho_values=[0.8 0.8]     % value of rho para for each pDim run
snr_values=0.01*[1  1]     % value of snr para for each pDim run
